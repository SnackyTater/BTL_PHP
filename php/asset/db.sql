...
create table bill (billID int not null auto_increment, bookID int, quantity int, customerName varchar(100), customerAddress varchar(255), billDate date, total int, primary key(billID));
